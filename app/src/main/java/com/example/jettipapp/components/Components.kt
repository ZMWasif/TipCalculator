...
}, label = { Text(text = labelId)}, leadingIcon = { Icon(imageVector = Icons.Rounded.Add, contentDescription = "Money Icon")},
    singleLine = isSingleLine, textStyle = TextStyle(fontSize = 18.sp, color = MaterialTheme.colorScheme.onBackground),
